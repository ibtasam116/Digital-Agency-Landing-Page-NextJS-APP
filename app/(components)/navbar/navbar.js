            ...
            <nav class="bg-[#122E99] text-white dark:bg-gray-900 px-[5%] md:px-[10%]">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col md:items-center p-4 md:p-0 rounded-lg bg-[#122E99] md:flex-row mt-1  md:space-x-3 space-y-3 md:space-y-0 md:mt-0 md:border-0 md:bg-[#122E99] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                            ...
                            <li>
                                <Link href="/contact" className="hover:text-sky-500 hover:underline transition-all delay-100">Contact</Link>
                            </li>
                            <li>
